...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridViewLogin" runat="server" AutoGenerateColumns="False" DataKeyNames="LogId" DataSourceID="SqlDataSourceLogin">
                <Columns>
            ...
            <asp:GridView ID="GridViewPictures" runat="server" AutoGenerateColumns="False" DataKeyNames="picId" DataSourceID="SqlDataSourcePictures">
                <Columns>
